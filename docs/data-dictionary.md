...
**Generated by:** `scripts/inspect_schema.py`
**Methodology:** Phase 0 schema inspection — no columns invented
**Verification:** All metrics and columns below are confirmed real
**Rows:** 10,000
**Columns:** 22
